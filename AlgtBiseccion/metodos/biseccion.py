...
def biseccion(
    ...
    datos_funcion = interpretar_expresion(expresion)
    ...
    fa = evaluar_funcion(funcion, a)
    fb = evaluar_funcion(funcion, b)
    if fa == 0:
        return {
            "raiz": a,
            "valor_funcion": 0.0,
    ...
    for iteracion in range(1, max_iteraciones + 1):
        ...
        if abs(fp) <= tolerancia or error <= tolerancia:
            return {
                "raiz": float(p),
